...
- [ ] 3 do (runbook-чеклист + owner-шаги + landing-поле при необходимости)
- [ ] 4 verify (G2 — первый живой автопост AC2 + наблюдение AC3/AC4)
- [ ] 5 review (auto, adversarial)
- [ ] 5.5 security (секрет-гигиена токена; skip-кандидат по коду)
