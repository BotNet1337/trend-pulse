...
| [TASK-047](./task-047-annual-quarterly-plans.md) | Годовые/квартальные планы — BillingPeriod QUARTER/YEAR, −10%/−20% (Pro 29/78/278, Trader 99/267/950) + витрины | E4 | planned | backend | 049, 017, 010 | 2026-06-11 |
...
| [TASK-061](./task-061-vps-ops-hygiene.md) | Ops-гигиена VPS — docker log-rotation, restore-check cron, диск/память/бэкап-алерты в ops-чат, fail2ban | F | planned | infra | 034, 057 | 2026-06-11 |
| [TASK-062](./task-062-ops-tests-mypy-debts.md) | Долги TASK-051 (закрыты PR #70 — G2-подтверждение) + integration-smoke в pr-checks против route-дрейфа | F | planned | backend | 051, 030 | 2026-06-11 |
...
| [TASK-064](./task-064-alert-feedback-web-ui.md) | Фидбек 👍/👎 в вебе — кнопки в alert detail, optimistic update, feedback-поля в AlertRead | F | planned | frontend | 042, 016 | 2026-06-11 |
| [TASK-065](./task-065-api-keys-ui.md) | API-ключи в SPA (Trader/Team) — список/выпуск one-time-modal/revoke + upgrade-CTA | F | planned | frontend | 028, 049 | 2026-06-11 |
| [TASK-066](./task-066-scorer-channels-count.md) | Scorer персистирует channels_count per cluster (scores-колонка, миграция) → честный «N каналов» в trending/cases | F | planned | backend | 022, 045 | 2026-06-11 |
| [TASK-067](./task-067-landing-cases-showcase-link.md) | Landing proof-of-speed — секция кейсов из GET /cases (SSR-fetch+кэш), ссылка на showcase-канал, фикс robots.txt | F | planned | frontend | 045, 018 | 2026-06-11 |
| [TASK-068](./task-068-external-analytics-plausible.md) | Внешняя аналитика Plausible (cookieless) — landing+SPA, события sign_up/pricing, замена GA4-копии в legal | F | planned | frontend | 018, 050 | 2026-06-11 |
...
| [TASK-072](./task-072-frontend-en-unification-polish.md) | EN-унификация SPA (i18n не вводим) + честная копия delete-account вместо «workspaces» | F | planned | frontend | 039 | 2026-06-11 |
