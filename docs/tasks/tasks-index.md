...
| [TASK-082](./task-082-persist-post-embeddings.md) | Persist per-post embeddings — пайплайн пишет уже вычисленный 384-d вектор в `posts.embedding` (NULL у всех 57 940 строк; переживает 48ч TTL текста → go-forward бэктесты кластеризации/vector-ML, compliance-friendly, без миграции) | — | review | backend | 022, 037, 080 | 2026-06-13 |
